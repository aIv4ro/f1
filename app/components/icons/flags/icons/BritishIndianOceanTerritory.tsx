...
export function BritishIndianOceanTerritory(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-io" viewBox="0 0 640 480">
      ...
      <path fill="#006d00" fillRule="evenodd" stroke="#fff" strokeWidth="1.8" d="m395.2 236.6 9.3-13-14.1 2.1 17.4-9.9-11.1-.5 20-7-11.1-.6 20-7-11.1-.6 23-9.6-11.2-.5 23-9.7-11.1-.5 23-9.6 11.5-4.9 5.6.3-.4 5.3-6.3 10.4-12.6 20.8.8-10.6-12.6 20.8.7-10.7-12.6 20.8.7-10.6-9.6 18.2.7-10.6-9.6 18.2.7-10.6-12.2 15.4 3.7-13.2-14.5 7.4z"/>
