...
export function ChristmasIsland(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-cx" viewBox="0 0 640 480">
      ...
      <g fill="#fff" transform="matrix(.64 0 0 .64 0 80)">
        ...
        <use width="100%" height="100%" x="2.5" y="269.1"/>
        <use width="100%" height="100%" x="-112.1" y="123.2"/>
        <use width="100%" height="100%" x="108.4" y="85"/>
      </g>
    </svg>
