...
export function CocosKeelingIslands(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-cc" viewBox="0 0 640 480">
      <defs>
      ...
      <g fill="#ffe000" transform="translate(0 80) scale(.0635)">
        <use width="100%" height="100%" x="7560" y="4200"/>
        <use width="100%" height="100%" x="6300" y="2205"/>
        <use width="100%" height="100%" x="7560" y="840"/>
        <use width="100%" height="100%" x="8680" y="1869"/>
        <use width="100%" height="100%" x="8064" y="2730"/>
      </g>
    </svg>
