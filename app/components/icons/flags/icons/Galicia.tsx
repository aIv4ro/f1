  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-es-ga" viewBox="0 0 640 480">
      ...
      <g font-size="12">
        ...
        <path fill="none" stroke="#000" strokeWidth=".5" d="m256 247.8 4.2-3.5-4.7-.9s.6.7.5 1.4v3zM337.6 242.7l-7.7 1.4 5.2 6" transform="matrix(1.06667 0 0 1.06758 0 -76)"/>
