...
export function Gibraltar(
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-gi" viewBox="0 0 640 480">
      ...
      <g stroke="#000" transform="translate(-160) scale(1.875)">
        ...
        <use width="100%" height="100%" transform="matrix(-1 0 0 1 512 0)"/>
        <g fill="#f8d80e">
          <g strokeLinecap="round">
            <path strokeWidth=".8" d="M273.3 150c-2.7 1-5 2.4-7.5 3.8a72.4 72.4 0 0 0-8.9 6c-1 .7-2 1.4-2.7 2.4-1 .8-2 2-1.8 3.5 0 .6.8-.8 1.4-.9a4.4 4.4 0 0 1 3.1-.4c1.3-1.4 3-2.3 4.4-3.4a77.4 77.4 0 0 1 13-7.6l-1-3.4z"/>
