...
export function Grenada(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-gd" viewBox="0 0 640 480">
      <defs>
        <g id="c">
          <g id="b">
      ...
      <use  width="100%" height="100%" transform="matrix(52.8 0 0 52.8 320 240)"/>
      <use  width="100%" height="100%" x="-100" transform="translate(-30.3)"/>
      <use  id="d" width="100%" height="100%" transform="matrix(31.2 0 0 31.2 320 33.6)"/>
      <use  width="100%" height="100%" x="100" transform="translate(30.3)"/>
      ...
      <use  width="100%" height="100%" x="-100" transform="translate(-30.3 414.6)"/>
      <use  width="100%" height="100%" transform="matrix(31.2 0 0 31.2 320 448.2)"/>
      <use  width="100%" height="100%" x="100" transform="translate(30.3 414.6)"/>
    </svg>
