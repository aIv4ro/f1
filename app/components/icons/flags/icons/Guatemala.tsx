...
export function Guatemala(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-gt" viewBox="0 0 640 480">
      <defs>
        <radialGradient id="a">
          <stop offset=".2" stopColor="#f9f0aa"/>
          <stop offset="1" stopColor="#b07e09"/>
        </radialGradient>
        <radialGradient  id="e" cx="447.4" cy="308.3" r="16.5" gradientUnits="userSpaceOnUse"/>
        <radialGradient id="b">
          <stop offset=".2" stopColor="#f9f0aa"/>
          <stop offset="1" stopColor="#b07e09"/>
        </radialGradient>
        <radialGradient  id="f" cx="451.6" cy="313" r="10.9" gradientUnits="userSpaceOnUse"/>
        <radialGradient  id="g" cx="454.1" cy="308.6" r="9.8" gradientUnits="userSpaceOnUse"/>
        <radialGradient  id="h" cx="458.4" cy="307.1" r="17.4" gradientUnits="userSpaceOnUse"/>
        <radialGradient  id="k" cx="446" cy="252.4" r="13" gradientUnits="userSpaceOnUse"/>
      ...
      <g transform="matrix(.81133 0 0 .8264 -69.4 -8)">
        ...
        <use  width="100%" height="100%" transform="scale(-1 1) rotate(-2.8 -9.3 19640.2)"/>
        ...
        <g id="d">
          <path fill="#b2b6ba" stroke="#485654" strokeWidth=".2" d="M508.5 360a237.5 237.5 0 0 0-76.1-68c3.5-.2 11.4 3.9 14.7 6 23.9 15.4 44.3 35.8 65.6 59.8-1.2 1.2-2 2-3.4 3l-.8-.8z"/>
        ...
        <use  width="100%" height="100%" transform="scale(-1 1) rotate(-3.4 -13.8 16470.8)"/>
        <g stroke="#24420e" strokeWidth=".2">
        ...
        <path fill="#eac102" stroke="#a08307" strokeWidth=".2" d="M473.2 215.3c-1 .2-1.4.6-2.2 1.4 1 .2 1.7.3 2.6.3.2 0 .3-.4.3-.6l-.2-1c0-.2-.6-.1-.8 0l.3-.1z"/>
