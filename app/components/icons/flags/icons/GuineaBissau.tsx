...
export function GuineaBissau(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-gw" viewBox="0 0 640 480">
      ...
      <use  width="100%" height="100%" transform="rotate(72 110 240)"/>
      <use  width="100%" height="100%" transform="rotate(144 110 240)"/>
      <use  width="100%" height="100%" transform="rotate(-144 110 240)"/>
      <use  width="100%" height="100%" transform="rotate(-72 110 240)"/>
    </svg>
