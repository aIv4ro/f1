...
export function Honduras(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-hn" viewBox="0 0 640 480">
      ...
      <use  width="100%" height="100%" transform="translate(133.3 -42.7)"/>
      <use  width="100%" height="100%" transform="translate(133.3 37.3)"/>
      <use  width="100%" height="100%" transform="translate(-133.3 -42.7)"/>
      <use  width="100%" height="100%" transform="translate(-133.3 37.3)"/>
    </svg>
