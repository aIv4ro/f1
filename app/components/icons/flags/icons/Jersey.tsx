...
export function Jersey(
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-je" viewBox="0 0 640 480">
      <defs>
        <clipPath id="a">
      ...
      <g clipPath="url(#a)" transform="matrix(16 0 0 16 84.8 96)">
        ...
        <path fill="#df112d" fillRule="evenodd" d="M-10.3-6v2L11.6 9l-21.8 13v2H-7l21.8-13 21.7 13h3.2v-2L18 9 39.8-4v-2h-3.3L14.7 7-7-6h-3.2z"/>
        <g stroke="#000">
          ...
          <path fill="none" strokeWidth=".1" d="M123.5 29.2c-.4-.2-.9-.3-1.4-.2m-5.6 0c-.4.8-.2 1.2-.1 1.6m-4-5.6c.2.2.4-.2.8.2-.1-.1-.3.3-.6 0m2-.1c-.3 0-.5-.3-.9.1.1-.1.3.3.6 0m-.6 0v.3c.1.7.3 1-.3 1-.5 0-.3-.3-.2-1v-.3" transform="matrix(.14 0 0 .15 -1.7 -.4)"/>
          <path fill="#ff0016" strokeWidth=".1" d="M113.5 27.7c.4 0 .6 0 .6-.6 0-.2.3-.3.1-.7.2.4-.7.4-.7.2 0 .2-1 .2-.8-.2-.1.4.2.5.1.7 0 .6.2.6.7.6z" transform="matrix(.14 0 0 .15 -1.7 -.4)"/>
          <path strokeWidth=".1" d="m113 26.5-1-.3m1 .3h-1m1 .1-.9.3m1.7-.4 1-.3m-1 .3h1.2m-1.2.1 1 .3" transform="matrix(.14 0 0 .15 -1.7 -.4)"/>
