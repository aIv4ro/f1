...
export function Kazakhstan(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-kz" viewBox="0 0 640 480">
      ...
      <g fill="#ffec2d">
        <g transform="matrix(.48 0 0 .48 345.8 201.6)">
          ...
          <g id="c">
            ...
            <use  width="100%" height="100%" transform="rotate(22.5)"/>
            <use  width="100%" height="100%" transform="rotate(45)"/>
            <use  width="100%" height="100%" transform="rotate(67.5)"/>
          </g>
          <use  width="100%" height="100%" transform="rotate(11.3)"/>
        </g>
        ...
        <g transform="scale(.48)">
          <g id="f">
            <g id="e">
              ...
              <use  width="100%" height="100%" transform="matrix(1 0 0 -1 0 645)"/>
            </g>
            <use  width="100%" height="100%" transform="matrix(-1 0 0 1 240 0)"/>
          </g>
          <use  width="100%" height="100%" transform="matrix(1 0 0 -1 0 1000)"/>
        </g>
      </g>
    </svg>
