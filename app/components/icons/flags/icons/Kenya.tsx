...
export function Kenya(
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-ke" viewBox="0 0 640 480">
      <defs>
      ...
      <g id="b" transform="matrix(3 0 0 3 320 240)">
        <use width="100%" height="100%" stroke="#000"/>
        <use width="100%" height="100%" fill="#fff"/>
      </g>
      <use  width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)"/>
