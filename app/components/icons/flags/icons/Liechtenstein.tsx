...
export function Liechtenstein(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-li" viewBox="0 0 640 480">
      ...
      <g fill="#ffd83d" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" transform="scale(.8)">
        ...
        <use width="100%" height="100%" transform="matrix(-1 0 0 1 444 0)"/>
