...
export function Paraguay(
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="flag-icons-py" viewBox="0 0 640 480">
      ...
      <path fill="#fedf00" stroke="#000" strokeWidth=".4" d="m327.6 249.5-7.6-5.3-7.6 5.3 2.9-8.4-6.7-5.2h8.6l2.8-8.4 2.8 8.4h8.6l-6.7 5.2 2.9 8.4z"/>
    </svg>
