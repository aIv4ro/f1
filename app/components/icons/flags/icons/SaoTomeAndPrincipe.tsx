...
export function SaoTomeAndPrincipe(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-st" viewBox="0 0 640 480">
      ...
      <use  width="100%" height="100%" x="700" transform="translate(-523.2)"/>
    </svg>
