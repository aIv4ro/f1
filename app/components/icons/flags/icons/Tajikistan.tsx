...
export function Tajikistan(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-tj" viewBox="0 0 640 480">
      ...
      <use width="100%" height="100%" fill="#f8c300" transform="matrix(-1 0 0 1 640 0)"/>
      ...
      <use  width="100%" height="100%" fill="#f8c300" transform="rotate(9.4 320 551.3)"/>
      <use  width="100%" height="100%" fill="#f8c300" transform="rotate(18.7 320 551.3)"/>
      ...
      <g id="d" fill="#f8c300" transform="translate(320 260.6) scale(.68571)">
        <use  width="100%" height="100%" transform="translate(-70 -121.2)"/>
        <use  width="100%" height="100%" transform="translate(-121.2 -70)"/>
        <use  width="100%" height="100%" transform="translate(-140)"/>
      </g>
      <use  width="100%" height="100%" fill="#f8c300" transform="matrix(-1 0 0 1 640 0)"/>
    </svg>
