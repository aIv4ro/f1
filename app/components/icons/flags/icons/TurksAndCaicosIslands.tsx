...
export function TurksAndCaicosIslands(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-tc" viewBox="0 0 640 480">
        ...
        <g strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2">
          ...
          <g fill="#9e540a" transform="matrix(.125 0 0 .125 535 249.6)">
            <g id="b">
              ...
              <g stroke="none">
                <use width="100%" height="100%" stroke="#fcd116" strokeWidth="12"/>
