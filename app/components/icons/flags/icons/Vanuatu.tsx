...
export function Vanuatu(
  {className}: IconProps
) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg"   id="flag-icons-vu" viewBox="0 0 640 480">
      <defs>
        <clipPath id="a">
      ...
      <g fill="#fdce12" transform="translate(-22) scale(1.01053)">
        ...
        <use  width="100%" height="100%" transform="matrix(-1 0 0 1 220 0)"/>
      </g>
    </svg>
